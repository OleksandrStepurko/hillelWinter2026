...
public class ParStream {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        Stream.of(1, 2, 3, 4, 5, 6, 7, 8, 9).parallel().sequential().forEach(s -> System.out.print(s + " "));        System.out.println();
        Stream.of(1, 2, 3, 4, 5, 6, 7, 8, 9).sequential().parallel().forEach(s -> System.out.print(s + " "));
