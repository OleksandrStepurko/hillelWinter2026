...
public class ISOCode {
    ...
    public static void main(String[] args) {
        ...
        Currency c1 = Currency.getInstance("UAH"); //Ukr hrivnya
        Currency c2 = Currency.getInstance("JPY");  //Japan Yen
        Currency c3 = Currency.getInstance("USD");  //USA dollar
        ...
        System.out.println("UAH Symbol : "+c1.getSymbol());
